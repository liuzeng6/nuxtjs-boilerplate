<template>
    <div class="bdabout-wrap1 dn" ref="content">
        <div class="bdabout-wrap1-inner w1410 clear">
            <div class="bdabout-wrap1-text f-27">
                <p>15年来巴顿只专注品牌咨询设计这一件事，懂美学，更懂生意！我们联合业内知名总监合力智建，致力于为客户提供品牌长期主义价值，核心板块包括：品牌战略咨询、品牌设计、产品战略、电商战略、门店空间战略、营销推广策略。我们靠专业和口碑赢得全球客户的信任，众多作品获德国红点奖、IF、意大利A'Design、Pentawards、台湾金点奖、香港HKDA环球设计等国际大奖。
                </p>
                <p>我们拥有新一代策略美学设计团队，更懂新人群、新消费、新零售！我们不断学习、总结、改进，十余年的成长，学会如何更好地协作，更好地照顾好我们的团队，照顾好我们的客户。我们犯过的错误、积累的经验与案例将是我们最宝贵的资产。
                </p>
            </div>
        </div>
    </div>
    <div class="bdabout-wrap2 dn">
        <div class="bdabout-wrap2-inner">
            <img :src="about_img2" alt="">
        </div>
    </div>

    <div class="bdabout-wrap3">
        <div class="bdabout-section bdabout-section1">
            <div class="bdabout-img w1700">
                <img :src="about_img3" alt="">
            </div>
            <div class="bdabout-main w1700 clear">
                <div class="bdabout-text f-27">
                    <p>我们泽水而居，应“运”而生，<br>我们坐落在美丽杭城的大运河畔。<br>如果说杭州以良渚文明为发源地，以西湖举世闻名，<br>那么大运河就是连接南北的经济纽带。</p>
                </div>
            </div>
        </div>
        <div class="bdabout-section bdabout-section2">
            <div class="bdabout-img w1700">
                <img :src="about_img4" alt="">
            </div>
            <div class="bdabout-main w1700 clear">
                <div class="bdabout-text f-27">
                    <p>干净、整洁、值得信任，从不花哨。<br>我们尊重每个品牌独有的气质，<br>它会通过语言、文字、视觉、以不同的形式展现在眼前。<br>请相信接触巴顿的第一感觉，我们一直如此，始终如此。
                    </p>
                </div>
            </div>
        </div>
        <div class="bdabout-section bdabout-section3">
            <div class="bdabout-img w1700">
                <div class="bdabout-img-item">
            ...
            <div class="bdabout-main w1700 clear">
                <div class="bdabout-text f-27">
                    <p>我们在繁华都市里披荆斩棘，创造属于我们的价值，<br>也在这片土壤里享受一隅宁静，让工作不只是工作。<br>一个舒适的环境，得以让身心松弛，可以在成长中爆发潜能，<br>也可以慢下来，找到属于自己的节奏，<br>手执烟火谋生，心怀诗意谋爱。
                    </p>
                </div>
            </div>
        </div>
        <div class="bdabout-section bdabout-section4">
            <div class="bdabout-img w1700">
                <img src="" alt="">
            </div>
        </div>
        <div class="bdabout-section bdabout-section5">
            <div class="bdabout-img w1700">
                <div class="bdabout-img-item">
                    <img src="" alt="">
                </div>
                <div class="bdabout-img-item">
                    <img src="" alt="">
                    <div class="bdabout-text f-27">
                        <p>开放易协作的办公环境往往意味着更舒适、更高效。<br>
                            在巴顿，我们极力推崇扁平化的办公模式，每个念头都在第一时间得到沟通与尊重；每个特立独行的灵魂在这里都得到了完美释放。<br>
                            他们神采奕奕，一群胆大年轻的水手们时刻准备着乘风破浪。</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="bdabout-section bdabout-section6">
            <div class="bdabout-img w1700">
                <img src="" alt="">
            </div>
            <div class="bdabout-main w1700 clear">
                <div class="bdabout-text f-27">
                    <p>我们永远赤诚、热烈，保有对生活的热情。<br>在这里，我们必将迎来新⼀轮的挑战，<br>创造更多的品牌价值！<br>让中国品牌更出色！</p>
                </div>
            </div>
        </div>
        <div class="bdabout-section bdabout-section7">
            <div class="bdabout-img w1700">
                <div class="bdabout-img-item">
                    <img src="" alt="">
                </div>
        ...
        <div class="bdabout-section bdabout-section8">
            <div class="bdabout-img w1700">
                <img src="" alt="">
            </div>
        </div>
        <div class="bdabout-section bdabout-section9">
            <div class="bdabout-img w1700">
                <img src="" alt="">
            </div>
        </div>
        <div class="bdabout-section bdabout-section10">
            <div class="bdabout-img w1700">
                <div class="bdabout-img-item">
                    <img src="" alt="">
                </div>
...
import about_img3 from "../assets/about/1722318252_1021.jpg";
import about_img4 from "../assets/about/1722318475_6971.jpg";
import about_img5 from "../assets/about/1722318610_2467.jpg";
import about_img6 from "../assets/about/1722318619_7751.jpg";
...
@media screen and (max-width: 1681px) {
    /* .warp5-more{width: 300px;height: 72px;line-height: 72px;font-size: 16px;margin-left:-151px;text-indent: 20px;}    .warp5-more i{margin-right: 20px;margin-top: 30px;} */
    /* .warp5-more:hover i{margin-right: 15px;} */
    /*     .warp5 .info p{font-size: 78px;}	.warp5 .info img{margin: 24px auto;display: block;width: 78px;} */
    /* .warp5-more{transform: scale(0.656);}	} */
}
...
@media screen and (max-width: 1367px) {
    /* .warp5-more{width: 200px;height: 48px;line-height: 48px;font-size: 12px;margin-left:-101px;text-indent: 0px;text-align: center;}    .warp5-more i{display:none;} */
    /* .warp5-more{transform: scale(0.534);} */
}
